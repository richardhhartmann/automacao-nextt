Private Sub Worksheet_Change(ByVal Target As Range)
    ...
    ' 1. PREPARA VERIFICAÇÃO EM DADOS CONSOLIDADOS (coluna AT)
    ultimaLinhaDados = wsDados.Cells(wsDados.Rows.Count, "AT").End(xlUp).Row
    If ultimaLinhaDados < 1 Then ultimaLinhaDados = 1
    Set rngDados = wsDados.Range("AT1:AT" & ultimaLinhaDados)
