    ...
    try:
        ...
        if "Cadastro de Marcas" in wb.sheetnames:
            try:
                ...
                print(f"Erro ao inserir marcas: {e}")
                conn.rollback()
                print("Continuando com a próxima operação...")
        else:
        ...
        if "Cadastro de Segmento" in wb.sheetnames:
            try:
                ...
                print(f"Erro ao inserir segmentos: {e}")
                conn.rollback()
                print("Continuando com a próxima operação...")
        else:
        ...
        if "Cadastro de Secao" in wb.sheetnames:
            try:
                ...
                print(f"Erro ao inserir seções: {e}")
                conn.rollback()
                print("Continuando com a próxima operação...")
        else:
        ...
        if "Cadastro de Especie" in wb.sheetnames:
            try:
                ...
                print(f"Erro ao inserir espécies: {e}")
                conn.rollback()
        else:
